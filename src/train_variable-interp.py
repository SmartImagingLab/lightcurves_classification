...
#         '--dataroot', type=str, default='../data', help='root to dataset. default ../data')
    parser.add_argument(
        '-b', '--batchsize', type=int, default=5, help='batch size')    # 初始:256
    parser.add_argument(
        '-e', '--epochs', type=int, default=50, help='number of training epochs')    # 初始:150
    parser.add_argument(
...
#     print(test_dataset_list)
    ...
    # 做类别的平衡！
    label_train = traindataloader.dataset.y
    nclasses = traindataloader.dataset.nclasses
    hist_train,_ = np.histogram(label_train, bins=nclasses)
    traindataloader.dataset.classweights = 1 / hist_train
